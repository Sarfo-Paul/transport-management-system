...
<!-- /Logo -->
              ...
              <h4 class="mb-1 text-primary font-weight-bold">Welcome to Transpass! 👋</h4>
<h5 class="mb-3 text-muted">A Smarter Way to Move Through Campus</h5>

<p class="mb-4 text-secondary">Sign in to your account and start the adventure with us!</p>
